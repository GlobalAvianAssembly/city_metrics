...
var stats = cities.map(function(feature) {
  ...
  .set('region_20_average_elevation', averageElevation(buffer_20k).min(0))
  ...
  .set('region_50_average_elevation', averageElevation(buffer_50k).min(0))
  ...
  .set('region_100_average_elevation', averageElevation(buffer_100k).min(0))
