...
var stats = cities.map(function(feature) {
  ...
  .set('city_average_elevation', averageElevation(polygon).min(0))
  .set('city_min_elevation', elevationMinMax_city.get('b1_min').min(0))
  .set('city_max_elevation', elevationMinMax_city.get('b1_max').min(0))
  .set('city_estuary_area', areaCoveredbyEstuaries(polygon))
  .set('region_average_elevation', averageElevation(buffer).min(0))
  .set('region_min_elevation', elevationMinMax_region.get('b1_min').min(0))
  .set('region_max_elevation', elevationMinMax_region.get('b1_max').min(0))
